...
{	
	...
	public static void getIP()
	{
		...
		/*
		 * This way the network code is executed asyncronously, with almost no extra code or effort.
		 */
	...
	static String retrieveWebpage(String url) throws Exception { return retrieveWebpage.call(url); }
	static void retrieveWebpage(String url, Callback<String> cb) throws Exception { retrieveWebpage.callAsync(url, cb); }
	
	/*
	 * If you need more flexibility in arguments, the easiest solution is probably to use a closure method:
	 * a method that creates an argumentless Function (called a Procedure) which can use the method's
	 * arguments in it's code.
	 */
